...
public class HiloVocalA extends Thread{
    String ficheroLeer;
    String ficheroEscribir;

    public HiloVocalA(String ficheroLeer, String ficheroEscribir) {
    ...
    public void run() {
        try {
            ...
            while ((linea = br.readLine()) != null){
                ...
                for (int i = 0; i < lineaSeparada.length; i++) {
                    ...
                    for (int j = 0; j < palabraSeparada.length; j++) {
                        ...
                        if (palabraMinusculas == 'a' || palabraMinusculas == 'á') contador++;
                    }
                }
            }
            ...
            bw.write("Total de apariciones 'a': " + contador);
            bw.close();
