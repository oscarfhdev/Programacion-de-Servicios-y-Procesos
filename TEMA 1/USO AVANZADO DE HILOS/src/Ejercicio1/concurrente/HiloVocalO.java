...
public class HiloVocalO extends Thread{
    String ficheroLeer;
    String ficheroEscribir;

    public HiloVocalO(String ficheroLeer, String ficheroEscribir) {
    ...
    public void run() {
        try {
            ...
            while ((linea = br.readLine()) != null){
                ...
                for (int i = 0; i < lineaSeparada.length; i++) {
                    ...
                    for (int j = 0; j < palabraSeparada.length; j++) {
                        ...
                        if (palabraMinusculas == 'o' || palabraMinusculas == 'ó') contador++;
                    }
                }
            }
            ...
            bw.write("Total de apariciones 'o': " + contador);
            bw.close();
